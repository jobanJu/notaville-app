...
export const demoLieux = [
  { id: 1, nom: 'Le Vivat', type: 'bar', description: 'Bar de quartier convivial près de la place, quelques bières pression et une terrasse au soleil.', quartierNom: 'Wazemmes', villeNom: 'Lille', noteMoyenne: 4.3, nbAvis: 28, latitude: 50.6229, longitude: 3.0454 },
  ...
  { id: 4, nom: 'La Chicorée', type: 'restaurant', description: 'Brasserie historique, spécialités du Nord.', quartierNom: 'Vieux-Lille', villeNom: 'Lille', noteMoyenne: 4.1, nbAvis: 54, latitude: 50.6407, longitude: 3.0603 },
  ...
  { id: 6, nom: 'Brasserie Théâtre', type: 'bar', description: 'Grande sélection de bières belges et locales à la pression, terrasse animée en soirée.', quartierNom: 'Lille-Centre', villeNom: 'Lille', noteMoyenne: 4.4, nbAvis: 76, latitude: 50.6365, longitude: 3.0635 },
  { id: 7, nom: 'Au Blé d\'Or', type: 'bar', description: 'Bar à bières artisanales, une trentaine de références du Nord et de Belgique.', quartierNom: 'Vauban-Esquermes', villeNom: 'Lille', noteMoyenne: 4.6, nbAvis: 143, latitude: 50.6255, longitude: 3.0500 },
  ...
  { id: 9, nom: 'Le Comptoir des Moulins', type: 'restaurant', description: 'Petit restaurant familial, cuisine du Maghreb et plats mijotés faits maison.', quartierNom: 'Lille-Moulins', villeNom: 'Lille', noteMoyenne: 4.5, nbAvis: 63, latitude: 50.6231, longitude: 3.0653 },
  ...
  { id: 11, nom: 'Fives Café', type: 'cafe', description: 'Café associatif, concerts le soir et brunch le dimanche.', quartierNom: 'Fives', villeNom: 'Lille', noteMoyenne: 4.2, nbAvis: 47, latitude: 50.6339, longitude: 3.0827 },
  ...
  { id: 13, nom: 'Le Canal', type: 'restaurant', description: 'Cuisine bistrot, terrasse au bord de la Deûle aux beaux jours.', quartierNom: 'Bois-Blancs', villeNom: 'Lille', noteMoyenne: 4.3, nbAvis: 58, latitude: 50.6420, longitude: 3.0295 },
  ...
  { id: 16, nom: 'Le Petit Béthune', type: 'restaurant', description: 'Cuisine familiale, plat du jour et ardoise qui change chaque semaine.', quartierNom: 'Faubourg de Béthune', villeNom: 'Lille', noteMoyenne: 4.2, nbAvis: 41, latitude: 50.6155, longitude: 3.0400 },
  ...
  { id: 18, nom: 'Boulangerie du Sud', type: 'boutique', description: 'Boulangerie artisanale, pain au levain cuit au feu de bois.', quartierNom: 'Lille-Sud', villeNom: 'Lille', noteMoyenne: 4.6, nbAvis: 87, latitude: 50.6091, longitude: 3.0503 },
  ...
  { id: 21, nom: 'Le Hellemmois', type: 'restaurant', description: 'Bistrot de quartier, cuisine traditionnelle et plats généreux.', quartierNom: 'Hellemmes', villeNom: 'Lille', noteMoyenne: 4.4, nbAvis: 49, latitude: 50.6280, longitude: 3.1000 },
  ...
  { id: 24, nom: 'Hôtel du Moulin', type: 'hotel', description: 'Petit hôtel calme en bord de Lomme, chambres simples et accueil familial.', quartierNom: 'Lomme', villeNom: 'Lille', noteMoyenne: 4.2, nbAvis: 33, latitude: 50.6396, longitude: 3.0102 },
]

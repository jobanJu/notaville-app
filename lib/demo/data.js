...
export const demoProfil = {
  pseudo: 'Test1',
  notacoins: 9500,
  notacoinsConvertibles: 42000,
  avatarEmoji: '🦊',
  avatarCouleur: '#FDBA74',
  ville_origine_code: '59350',
  villeNom: 'Lille',
  // Progression Quiz éclair (voir supabase/42_quiz_eclair_niveaux.sql) :
  // niveau 3 débloqué, niveau 3 déjà réussi une fois -- assez pour
  // montrer le bouton "Débloquer le niveau 4" en démo.
  niveauQuizEclair: 3,
  niveauQuizEclairReussi: 3,
  // Un article équipé par type (voir supabase/37_boutique_v2.sql,
  // mes_equipements()) -- démo statique, cohérente avec
  // demoBoutiqueArticles (l'Étoile filante y est marquée possédée+équipée).
  equipements: [{ type: 'badge_cosmetique', nom: 'Étoile filante', valeur: 'etincelle' }],
}
...
// Avis individuels et photos de démo pour /villes/[code] -- affichés
// tels quels par AvisListe/PhotosVille (pas de moyenne ici, voir
// avis_ville()/photos_ville() côté SQL, migration 27).
export const demoAvisVilles = {
  '59350': [
    {
      id: 1,
      pseudo: 'MarieV',
      note: 5,
      points_forts: ['marché tous les jours', 'transports pratiques'],
      points_faibles: ['pluie fréquente'],
      commentaire: "J'habite Lille depuis 3 ans, le centre est hyper vivant et on n'a jamais besoin de voiture.",
      est_resident: true,
    ...
    },
    {
      ...
      pseudo: 'Test1',
      note: 4,
      points_forts: ['vieux Lille magnifique'],
      points_faibles: [],
      commentaire: "Week-end sympa, la Grand'Place et le vieux Lille valent le détour.",
      est_resident: false,
...
export const demoPhotosVilles = {
  '59350': [
    { id: 1, pseudo: 'MarieV', photo_url: 'https://images.unsplash.com/photo-1591817582632-e3b2c8f2e8b9?w=400', created_at: new Date().toISOString() },
    { id: 2, pseudo: 'Test1', photo_url: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?w=400', created_at: new Date().toISOString() },
  ],
}

// Évènements et mur de discussion de démo -- CalendrierEvenements filtre
// par mois côté client, donc ces dates restent relatives à "maintenant"
// pour rester visibles quel que soit le jour où la démo est testée.
function dansNJours(n, heure = 19) {
  const d = new Date()
...
export const demoEvenements = {
  '59350': [
    { id: 1, titre: 'Concert au Zénith', type_evenement: 'concert', lieu: 'Zénith de Lille', description: 'Tournée française, dernière date de la saison.', date_debut: dansNJours(4, 20), lien_externe: null },
    { id: 2, titre: 'Marché de Wazemmes', type_evenement: 'marche', lieu: 'Place de la Nouvelle Aventure', description: 'Le grand marché du dimanche matin.', date_debut: dansNJours(2, 8), lien_externe: null },
    { id: 3, titre: 'Exposition photo Vieux-Lille', type_evenement: 'exposition', lieu: 'Palais des Beaux-Arts', description: "Rétrospective sur l'évolution du quartier.", date_debut: dansNJours(10, 10), lien_externe: null },
  ],
}

export const demoMessagesVille = {
  '59350': [
    { id: 1, pseudo: 'MarieV', contenu: 'Quelqu\'un connaît un bon café pour travailler près de la gare Lille Flandres ?', created_at: dansNJours(-1) },
    { id: 2, pseudo: 'Test1', contenu: "Le café Méo juste en face, super ambiance et wifi correct !", created_at: dansNJours(-1, 15) },
  ],
}

// Boutique cosmétique (voir supabase/32_boutique_cosmetique.sql) et
// messagerie (voir supabase/33_messagerie.sql) -- démo statique, achats
// et envois de messages simulés en local uniquement (components/Boutique.js,
// components/Messagerie.js), jamais persistés.
export const demoBoutiqueArticles = [
  { id: 1, nom: 'Étoile filante', description: 'Un petit badge scintillant à côté de ton pseudo.', type: 'badge_cosmetique', valeur: 'etincelle', prix_notacoins: 2000, possede: true, equipe: true },
  { id: 5, nom: 'Pseudo bleu nuit', description: 'Ton pseudo en bleu profond.', type: 'couleur_pseudo', valeur: 'text-[#3B5BA9] font-bold', prix_notacoins: 2000, possede: false, equipe: false },
  { id: 6, nom: 'Cadre bronze', description: 'Un liseré bronze autour de ton avatar.', type: 'cadre_pseudo', valeur: 'ring-2 ring-[#B08D57]', prix_notacoins: 3000, possede: false, equipe: false },
  { id: 3, nom: 'Pseudo doré', description: "Ton pseudo s'affiche en doré partout sur le site.", type: 'couleur_pseudo', valeur: 'text-amber-ink font-bold', prix_notacoins: 5000, possede: false, equipe: false },
  { id: 7, nom: 'Habitué', description: 'Un titre affiché sous ton pseudo.', type: 'titre', valeur: 'Habitué de Notaville', prix_notacoins: 6000, possede: false, equipe: false },
  { id: 2, nom: 'Couronne', description: 'Pour les grands contributeurs.', type: 'badge_cosmetique', valeur: 'couronne', prix_notacoins: 8000, possede: false, equipe: false },
  { id: 8, nom: 'Cadre argent', description: 'Un liseré argenté autour de ton avatar.', type: 'cadre_pseudo', valeur: 'ring-2 ring-[#9CA3AF]', prix_notacoins: 10000, possede: false, equipe: false },
  { id: 4, nom: 'Ambassadeur', description: 'Un titre affiché sous ton pseudo.', type: 'titre', valeur: 'Ambassadeur Notaville', prix_notacoins: 15000, possede: false, equipe: false },
  { id: 9, nom: 'Cadre or', description: 'Un liseré doré autour de ton avatar.', type: 'cadre_pseudo', valeur: 'ring-2 ring-[#D4AF37]', prix_notacoins: 30000, possede: false, equipe: false },
  { id: 10, nom: 'Pilier de Notaville', description: 'Le badge le plus rare -- pour les plus grands contributeurs.', type: 'badge_cosmetique', valeur: 'couronne', prix_notacoins: 50000, possede: false, equipe: false },
]
...
export const demoConversations = [
  {
    ...
    type: 'privee',
    autre_pseudo: 'MarieV',
    dernier_message: 'Le café Méo juste en face, super ambiance et wifi correct !',
    dernier_message_le: dansNJours(-1, 15),
    non_lus: 1,
    messages: [
      { id: 'm1', expediteur_id: 'autre', contenu: 'Salut ! Tu connais un bon café pour bosser près de la gare ?', created_at: dansNJours(-1) },
      { id: 'm2', expediteur_id: 'demo', contenu: 'Le café Méo juste en face, super ambiance et wifi correct !', created_at: dansNJours(-1, 15) },
    ],
  },
]
